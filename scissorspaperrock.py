...
if user_choice == options[0] and computer_choice == options[2]:
    print('The computer chose ' +str(computer_choice) + ' and you chose ' +str(user_choice) + '\nThe computer won!')
if user_choice == options[1] and computer_choice == options[0]:
    print('The computer chose ' +str(computer_choice) +' and you chose ' +str(user_choice) +'\nThe computer Won!')
if user_choice == options[1] and computer_choice == options[2]:
    print('The computer chose ' +str(computer_choice) +' and you chose ' +str(user_choice) +'\nYou won!')
if user_choice == options[2] and computer_choice == options[0]:
    print('The computer chose ' +str(computer_choice) +' and you chose ' +str(user_choice) +'\nYou won!')
if user_choice == options[2] and computer_choice == options[1]:
    print('The computer chose ' +str(computer_choice) +' and you chose ' +str(user_choice) +'\nThe computer Won')
